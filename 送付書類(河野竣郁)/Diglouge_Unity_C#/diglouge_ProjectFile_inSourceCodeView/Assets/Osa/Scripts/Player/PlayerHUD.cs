...
namespace Battle
{
    public class PlayerHUD : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                // 瀕死状態なら、瀕死画像を表示
                _hurtImage.enabled = _player.CurrentHealthState.Value == HealthState.Dying;
            ...
            _player.CurrentExp.Subscribe(x =>
            {
                var a = x % _player.NeedExp;

                _expGauge.fillAmount = (float)a / _player.NeedExp;
            }).AddTo(this);
        }
